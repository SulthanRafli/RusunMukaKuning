            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Lihat Data Jenis Kerusakan</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form>
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="text" class="form-control" placeholder="Nama" value="<?php echo $data_jenis_kerusakan->nama ?>" disabled>
                                </div>
                            </div>
