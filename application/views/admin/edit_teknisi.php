                        ...
                        <form id="basic">
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="text" class="form-control" placeholder="Nama Lengkap" value="<?php echo $data_teknisi->nama ?>" name="nama" required>
                                </div>
                            </div>
                            <div class="card-footer text-right">
                                <a type="button" class="btn btn-danger" href="<?php echo base_url(); ?>admin/C_teknisi">Kembali</a>
                                <button type="button-submit" class="btn btn-primary" onclick="edit(<?php echo $data_teknisi->idTeknisi ?>)">Ubah</button>
                            </div>
                        </form>
                    </div>
                </div>
