...
class C_maintenance extends CI_Controller
{
    ...
    {
        $data['page']          = "admin/list_maintenance";
    ...
    public function add()
    {
        $data['page']                   = "admin/add_maintenance";
        $data['classAktif']             = "maintenance";
    ...
    {
        $result     = $this->M_maintenance->save();
        $status     = $result;
    ...
    {
        $data['page']               = "admin/view_maintenance";
        $data['classAktif']         = "maintenance";
    ...
    {
        $data['page']                   = "admin/edit_maintenance";
        $data['classAktif']             = "maintenance";
        $data['list_penyewa']           = $this->M_penyewa->getAll();
        $data['list_jenis_kerusakan']   = $this->M_jenis_kerusakan->getAll();
        $data['data_maintenance']       = $this->M_maintenance->getById($id);
    ...
    {
        $result     = $this->M_maintenance->update($id);
        $status     = $result;
    ...
    {
        $result     = $this->M_maintenance->delete($id);
        $status     = $result;
